              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="flex-1 px-3 py-2 bg-slate-700 text-white text-center rounded-lg hover:bg-slate-600 transition-colors text-sm"
                  >
                    GitHub
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 px-3 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center rounded-lg hover:shadow-lg hover:shadow-purple-500/30 transition-all text-sm"
                  >
                    Live Demo
                  </a>
                </div>

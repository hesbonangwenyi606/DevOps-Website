          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300">
                <svg
                  className="w-5 h-5 flex-shrink-0 transform transition-transform duration-300 hover:scale-110 hover:text-purple-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300">
                <svg
                  className="w-5 h-5 flex-shrink-0 transform transition-transform duration-300 hover:scale-110 hover:text-green-500"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
